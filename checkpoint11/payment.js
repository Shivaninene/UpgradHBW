...
function origin(){
    ...
    newItem2.innerHTML='<button style="border:none;" type="button" id="b" class="btn btn-light btn-sm" data-toggle="modal" data-target="#myModal" data-backdrop="false">Login</button>';
